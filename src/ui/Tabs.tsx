...
export const TabPanels = (props: ComponentProps<"section">) => {
	...
	return (
		...
		>
			<div
				role="region"
				class="flex flex-col h-full grow w-full"
			>
				{/* <div
					role="region"
				...
				<ul
					...
					class="flex grow overflow-x-scroll snap-x snap-mandatory"
					classList={{
						"no-scrollbar": true,
					}}
				>
...
export const TabPanel = (props: ComponentProps<"li">) => {
	return (
		<li
			class="w-full overflow-hidden grow snap-start flex-shrink-0 flex flex-col items-center justify-center"
