...
// Taken from https://github.com/LXSMNSYC/solid-headless/blob/main/packages/solid-headless/src/utils/dynamic-prop.ts
// Thank God I find it otherwise I don't know how would I implement this feature.
// To provide some basic functionality that might be helpful for everyone.
