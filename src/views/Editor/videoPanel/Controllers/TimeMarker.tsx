	...
	return (
		...
		>
			<div
				...
				draggable="true"
				ref={(el) => (markerRef = el)}
				class="relative w-0 h-0 border-slate-500 border-8 border-x-transparent border-b-transparent"
			>
				<div class="h-28 absolute -left-px -top-0.5 bg-slate-700 w-0.5"></div>
			</div>
		</div>
	)
}
